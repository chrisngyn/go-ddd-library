...
type Book struct {
	...
	BookStatus      BookStatus  `boil:"book_status" json:"book_status" toml:"book_status" yaml:"book_status"`
	PatronID        null.String `boil:"patron_id" json:"patron_id,omitempty" toml:"patron_id" yaml:"patron_id,omitempty"`
	HoldTill        null.Time   `boil:"hold_till" json:"hold_till,omitempty" toml:"hold_till" yaml:"hold_till,omitempty"`
	CheckedOutAt    null.Time   `boil:"checked_out_at" json:"checked_out_at,omitempty" toml:"checked_out_at" yaml:"checked_out_at,omitempty"`
...
var BookTableColumns = struct {
	...
	ID:              "books.id",
	LibraryBranchID: "books.library_branch_id",
	BookType:        "books.book_type",
	BookStatus:      "books.book_status",
	PatronID:        "books.patron_id",
	HoldTill:        "books.hold_till",
	CheckedOutAt:    "books.checked_out_at",
...
type whereHelperBookStatus struct{ field string }

func (w whereHelperBookStatus) EQ(x BookStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperBookStatus) NEQ(x BookStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperBookStatus) LT(x BookStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperBookStatus) LTE(x BookStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperBookStatus) GT(x BookStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperBookStatus) GTE(x BookStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperBookStatus) IN(slice []BookStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperBookStatus) NIN(slice []BookStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var BookWhere = struct {
	...
	BookStatus      whereHelperBookStatus
	PatronID        whereHelpernull_String
	HoldTill        whereHelpernull_Time
	CheckedOutAt    whereHelpernull_Time
	CreatedAt       whereHelpertime_Time
	UpdatedAt       whereHelpertime_Time
	DeletedAt       whereHelpernull_Time
}{
	ID:              whereHelperstring{field: "\"books\".\"id\""},
	LibraryBranchID: whereHelperstring{field: "\"books\".\"library_branch_id\""},
	BookType:        whereHelperBookType{field: "\"books\".\"book_type\""},
	BookStatus:      whereHelperBookStatus{field: "\"books\".\"book_status\""},
	PatronID:        whereHelpernull_String{field: "\"books\".\"patron_id\""},
	HoldTill:        whereHelpernull_Time{field: "\"books\".\"hold_till\""},
	CheckedOutAt:    whereHelpernull_Time{field: "\"books\".\"checked_out_at\""},
...
var (
	bookAllColumns            = []string{"id", "library_branch_id", "book_type", "book_status", "patron_id", "hold_till", "checked_out_at", "created_at", "updated_at", "deleted_at"}
	bookColumnsWithoutDefault = []string{"id", "library_branch_id", "book_type", "book_status"}
	bookColumnsWithDefault    = []string{"patron_id", "hold_till", "checked_out_at", "created_at", "updated_at", "deleted_at"}
